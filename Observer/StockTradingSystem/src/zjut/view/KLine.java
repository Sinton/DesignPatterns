...
public class KLine extends JFrame {
	...
	public Component getKLineView() {
		...
		/*series.add(new Second(00, 06, 9, 26, 9, 2007), 9.2, 9.58, 9.16, 9.34);
		series.add(new Second(05, 07, 9, 26, 9, 2007), 8.9, 9.06, 8.83, 8.96);
		series.add(new Second(10, 07, 9, 26, 9, 2007), 9.0, 9.1, 8.82, 9.04);*/
		...
		try {
			x1Axis.setRange(dateFormat.parse("2007-08-20 00:00:00"),dateFormat.parse("2007-09-29 00:00:00"));// 设置时间范围，注意时间的最大值要比已有的时间最大值要多一天
		} catch (Exception e) {
			e.printStackTrace();
		}
		...
		x1Axis.setDateFormatOverride(new SimpleDateFormat("yyyy-MM-dd kk:mm:ss"));// 设置显示时间的格式
